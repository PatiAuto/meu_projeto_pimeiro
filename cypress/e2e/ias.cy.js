...
it('cadastra coordenador exceção campos obrigatorios', () => {  
  ...
  //CENARIO 4 cadastra gestor escolar único
...
cy.get(':nth-child(1) > .MuiPaper-root > .MuiCardContent-root > .MuiGrid-spacing-xs-2 > :nth-child(1) > .MuiGrid-root > :nth-child(1) > .MuiBox-root')
  ...
  //CENARIO 4.1 cadastra gestor escolar único exceção campos obrigatorios
...
cy.get('P[class="MuiFormHelperText-root MuiFormHelperText-contained Mui-error"]')
  ...
  //CENARIO 5 cadastra professor único

it('cadastra professor único', () => {  
 // Funções utilitárias
...
cy.get(':nth-child(1) > .MuiPaper-root > .MuiCardContent-root > .MuiGrid-spacing-xs-2 > :nth-child(1) > .MuiGrid-root > :nth-child(1) > .MuiBox-root')
  ...
  //CENARIO 5 cadastra professor único exceção campos obrigatorios
...
//CENARIO 6.1 cadastra turma única exceção campos obrigatorios
...
cy.get('#teacherDisciplines-helper-text')
  ...
  //CENARIO 6.2  cadastra turma única exceção campos obrigatorios
